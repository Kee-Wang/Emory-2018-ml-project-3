...
The training loss plot of SGD is showed as Figure 
(plot)
We can then get the convergence rate = 

Compare these three convergence rates, we have the conclusion that, xxx optimizer suits best for these model.
...
\begin{enumerate}
\item
{\tt learning\_rate = 1E-5} 

\item
Size of filter:  $5\times5$

\item
Number of filters: 32 for first layer and 64 for second layer

\item
Number of convolutional and pooling layers: 2
...
\item
Optimizer: {\tt Gradient Descent}

(Needs data and analysis of final model).
